...
function Footer() {
  return (
    <div className='flex w-full h-screen gap-5 px-10 py-20'>
        <div className='flex flex-col justify-between w-1/2 h-full'>
            <div className="headings">
                <h1 className='text-[6vw] leading-none font-semibold uppercase'>Eye-</h1>
                <h1 className='text-[6vw] leading-none font-semibold uppercase '>Opening</h1>
            </div>
        ...
        <div className='relative w-1/2'>
            <h1 className='text-[6vw] leading-none font-semibold uppercase'>presentations</h1>
            <div className='my-20'>
                {["Facebook", "Twitter", "Instgram"].map((item, index) => <a className='block text-xl capitalize' href="#">{item}</a>)}
            </div>
            <div className='my-10'>
                {["202-1966 W 4th Ave", "Vancouver Canada", "Ukraine"].map((item, index) => <a className='block text-xl capitalize' href="#">{item}</a>)}
            </div>

            <div className='absolute bottom-0 flex justify-between w-full text-lg'> 
                <p className='text-zinc-400'>&copy;ochi design 2024</p>
                <p className='text-zinc-400'>Website by pavan</p>
            </div>
        </div>
    </div>
  )
